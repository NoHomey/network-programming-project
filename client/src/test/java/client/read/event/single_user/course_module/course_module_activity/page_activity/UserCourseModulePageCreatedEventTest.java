...
public class UserCourseModulePageCreatedEventTest {
    UserCourseModulePageCreatedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModulePageCreatedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModulePageCreatedEvent event = UserCourseModulePageCreatedEvent.fromDescription("The user with id '2' created the 'page' activity with course module id '4369'.");
            assertEquals("The user with id '2' created the 'page' activity with course module id '4369'.", event.valueForDescription());
