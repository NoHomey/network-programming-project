...
public class UserCourseModulePageViewedEventTest {
    UserCourseModulePageViewedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModulePageViewedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModulePageViewedEvent event = UserCourseModulePageViewedEvent.fromDescription("The user with id '2' viewed the 'page' activity with course module id '4369'.");
            assertEquals("The user with id '2' viewed the 'page' activity with course module id '4369'.", event.valueForDescription());
