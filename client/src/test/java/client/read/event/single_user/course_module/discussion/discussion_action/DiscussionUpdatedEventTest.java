...
public class DiscussionUpdatedEventTest {
    DiscussionUpdatedEvent event;

    @Before
    public void initialize() {
        event = new DiscussionUpdatedEvent(2436, 209, 81);
    }

    @Test
    public void testFromDescription() {
        try {
            DiscussionUpdatedEvent event = DiscussionUpdatedEvent.fromDescription("The user with id '2436' has updated the discussion with id '209' in the forum with course module id '81'.");
            assertEquals("The user with id '2436' has updated the discussion with id '209' in the forum with course module id '81'.", event.valueForDescription());
    ...
    public void testValueForEventName() {
        assertEquals("Discussion updated", event.valueForEventName());
    }
