...
public class CourseSectionDeletedEventTest {
    CourseSectionDeletedEvent event;

    @Before
    public void initialize() {
        event = new CourseSectionDeletedEvent(2, 0, 49);
    }

    @Test
    public void testFromDescription() {
        try {
            CourseSectionDeletedEvent event = CourseSectionDeletedEvent.fromDescription("The user with id '2' deleted section number '0' for the course with id '49'");
            assertEquals("The user with id '2' deleted section number '0' for the course with id '49'", event.valueForDescription());
    ...
    public void testValueForEventName() {
        assertEquals("Course section deleted", event.valueForEventName());
    }
