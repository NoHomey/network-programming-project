...
public class UserCourseModuleFileViewedEventTest {
    UserCourseModuleFileViewedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModuleFileViewedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModuleFileViewedEvent event = UserCourseModuleFileViewedEvent.fromDescription("The user with id '2' viewed the 'resource' activity with course module id '4369'.");
            assertEquals("The user with id '2' viewed the 'resource' activity with course module id '4369'.", event.valueForDescription());
