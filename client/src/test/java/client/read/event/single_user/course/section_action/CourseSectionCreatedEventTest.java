...
public class CourseSectionCreatedEventTest {
    CourseSectionCreatedEvent event;

    @Before
    public void initialize() {
        event = new CourseSectionCreatedEvent(2, 0, 49);
    }

    @Test
    public void testFromDescription() {
        try {
            CourseSectionCreatedEvent event = CourseSectionCreatedEvent.fromDescription("The user with id '2' created section number '0' for the course with id '49'");
            assertEquals("The user with id '2' created section number '0' for the course with id '49'", event.valueForDescription());
    ...
    public void testValueForEventName() {
        assertEquals("Course section created", event.valueForEventName());
    }
