...
public class CalendarEventCreatedEventTest {
    CalendarEventCreatedEvent event;

    @Before
    public void initialize() {
        event = new CalendarEventCreatedEvent(2436, "Предаване на курсови работи по Програмни езици", 1379);
    }

    @Test
    public void testFromDescription() {
        try {
            CalendarEventCreatedEvent event = CalendarEventCreatedEvent.fromDescription("The user with id '2436' created the event 'Предаване на курсови работи по Програмни езици' with id '1379'.");
            assertEquals("The user with id '2436' created the event 'Предаване на курсови работи по Програмни езици' with id '1379'.", event.valueForDescription());
    ...
    public void testValueForEventName() {
        assertEquals("Calendar event created", event.valueForEventName());
    }
