...
public class UserCourseModuleForumUpdatedEventTest {
    UserCourseModuleForumUpdatedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModuleForumUpdatedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModuleForumUpdatedEvent event = UserCourseModuleForumUpdatedEvent.fromDescription("The user with id '2' updated the 'forum' activity with course module id '4369'.");
            assertEquals("The user with id '2' updated the 'forum' activity with course module id '4369'.", event.valueForDescription());
