...
public class UserCourseModulePageDeletedEventTest {
    UserCourseModulePageDeletedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModulePageDeletedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModulePageDeletedEvent event = UserCourseModulePageDeletedEvent.fromDescription("The user with id '2' deleted the 'page' activity with course module id '4369'.");
            assertEquals("The user with id '2' deleted the 'page' activity with course module id '4369'.", event.valueForDescription());
