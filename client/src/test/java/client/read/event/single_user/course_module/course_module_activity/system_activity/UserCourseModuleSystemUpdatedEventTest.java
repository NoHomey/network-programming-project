...
public class UserCourseModuleSystemUpdatedEventTest {
    UserCourseModuleSystemUpdatedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModuleSystemUpdatedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModuleSystemUpdatedEvent event = UserCourseModuleSystemUpdatedEvent.fromDescription("The user with id '2' updated the 'resource' activity with course module id '4369'.");
