...
public class CalendarEventDeletedEventTest {
    CalendarEventDeletedEvent event;

    @Before
    public void initialize() {
        event = new CalendarEventDeletedEvent(2436, "Предаване на курсови работи по Програмни езици", 1379);
    }

    @Test
    public void testFromDescription() {
        try {
            CalendarEventDeletedEvent event = CalendarEventDeletedEvent.fromDescription("The user with id '2436' deleted the event 'Предаване на курсови работи по Програмни езици' with id '1379'.");
            assertEquals("The user with id '2436' deleted the event 'Предаване на курсови работи по Програмни езици' with id '1379'.", event.valueForDescription());
    ...
    public void testValueForEventName() {
        assertEquals("Calendar event deleted", event.valueForEventName());
    }
