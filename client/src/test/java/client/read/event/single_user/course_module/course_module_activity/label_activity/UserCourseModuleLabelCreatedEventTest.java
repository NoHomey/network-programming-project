...
public class UserCourseModuleLabelCreatedEventTest {
    UserCourseModuleLabelCreatedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModuleLabelCreatedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModuleLabelCreatedEvent event = UserCourseModuleLabelCreatedEvent.fromDescription("The user with id '2' created the 'label' activity with course module id '4369'.");
            assertEquals("The user with id '2' created the 'label' activity with course module id '4369'.", event.valueForDescription());
