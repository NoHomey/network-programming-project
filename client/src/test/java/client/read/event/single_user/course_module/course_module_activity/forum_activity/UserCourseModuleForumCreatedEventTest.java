...
public class UserCourseModuleForumCreatedEventTest {
    UserCourseModuleForumCreatedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModuleForumCreatedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModuleForumCreatedEvent event = UserCourseModuleForumCreatedEvent.fromDescription("The user with id '2' created the 'forum' activity with course module id '4369'.");
            assertEquals("The user with id '2' created the 'forum' activity with course module id '4369'.", event.valueForDescription());
