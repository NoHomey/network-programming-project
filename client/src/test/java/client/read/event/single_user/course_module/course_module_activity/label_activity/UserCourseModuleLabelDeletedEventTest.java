...
public class UserCourseModuleLabelDeletedEventTest {
    UserCourseModuleLabelDeletedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModuleLabelDeletedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModuleLabelDeletedEvent event = UserCourseModuleLabelDeletedEvent.fromDescription("The user with id '2' deleted the 'label' activity with course module id '4369'.");
            assertEquals("The user with id '2' deleted the 'label' activity with course module id '4369'.", event.valueForDescription());
