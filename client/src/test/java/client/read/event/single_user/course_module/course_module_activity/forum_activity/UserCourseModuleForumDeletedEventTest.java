...
public class UserCourseModuleForumDeletedEventTest {
    UserCourseModuleForumDeletedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModuleForumDeletedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModuleForumDeletedEvent event = UserCourseModuleForumDeletedEvent.fromDescription("The user with id '2' deleted the 'forum' activity with course module id '4369'.");
            assertEquals("The user with id '2' deleted the 'forum' activity with course module id '4369'.", event.valueForDescription());
