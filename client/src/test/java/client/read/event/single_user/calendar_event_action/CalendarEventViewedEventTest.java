...
public class CalendarEventViewedEventTest {
    CalendarEventViewedEvent event;

    @Before
    public void initialize() {
        event = new CalendarEventViewedEvent(2436, "Предаване на курсови работи по Програмни езици", 1379);
    }

    @Test
    public void testFromDescription() {
        try {
            CalendarEventViewedEvent event = CalendarEventViewedEvent.fromDescription("The user with id '2436' viewed the event 'Предаване на курсови работи по Програмни езици' with id '1379'.");
            assertEquals("The user with id '2436' viewed the event 'Предаване на курсови работи по Програмни езици' with id '1379'.", event.valueForDescription());
    ...
    public void testValueForEventName() {
        assertEquals("Calendar event viewed", event.valueForEventName());
    }
