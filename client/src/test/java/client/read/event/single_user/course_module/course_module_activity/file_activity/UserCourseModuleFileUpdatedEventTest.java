...
public class UserCourseModuleFileUpdatedEventTest {
    UserCourseModuleFileUpdatedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModuleFileUpdatedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModuleFileUpdatedEvent event = UserCourseModuleFileUpdatedEvent.fromDescription("The user with id '2' updated the 'resource' activity with course module id '4369'.");
            assertEquals("The user with id '2' updated the 'resource' activity with course module id '4369'.", event.valueForDescription());
