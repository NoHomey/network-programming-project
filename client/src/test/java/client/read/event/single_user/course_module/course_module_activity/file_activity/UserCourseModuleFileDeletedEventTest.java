...
public class UserCourseModuleFileDeletedEventTest {
    UserCourseModuleFileDeletedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModuleFileDeletedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModuleFileDeletedEvent event = UserCourseModuleFileDeletedEvent.fromDescription("The user with id '2' deleted the 'resource' activity with course module id '4369'.");
            assertEquals("The user with id '2' deleted the 'resource' activity with course module id '4369'.", event.valueForDescription());
    ...
    public void testValueForComponent() {
        assertEquals("File", event.valueForComponent());
    }

    @Test
    public void testValueForEventName() {
        assertEquals("Course module deleted", event.valueForEventName());
    }
    ...
    public void testValueForActivity() {
        assertEquals("resource", event.valueForActivity());
    }
