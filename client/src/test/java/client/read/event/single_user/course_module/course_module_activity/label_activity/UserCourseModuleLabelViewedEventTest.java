...
public class UserCourseModuleLabelViewedEventTest {
    UserCourseModuleLabelViewedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModuleLabelViewedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModuleLabelViewedEvent event = UserCourseModuleLabelViewedEvent.fromDescription("The user with id '2' viewed the 'label' activity with course module id '4369'.");
            assertEquals("The user with id '2' viewed the 'label' activity with course module id '4369'.", event.valueForDescription());
