...
public class EnrolmentInstanceDeletedEventTest {
    EnrolmentInstanceDeletedEvent event;

    @Before
    public void initialize() {
        event = new EnrolmentInstanceDeletedEvent(2, "cohort", 1201);
    }

    @Test
    public void testFromDescription() {
        try {
            EnrolmentInstanceDeletedEvent event = EnrolmentInstanceDeletedEvent.fromDescription("The user with id '2' deleted the instance of enrolment method 'cohort' with id '1201'.");
            assertEquals("The user with id '2' deleted the instance of enrolment method 'cohort' with id '1201'.", event.valueForDescription());
    ...
    public void testValueForEventName() {
        assertEquals("Grouping deleted", event.valueForEventName());
    }
