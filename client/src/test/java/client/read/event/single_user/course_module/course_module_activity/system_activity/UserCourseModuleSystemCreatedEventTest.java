...
public class UserCourseModuleSystemCreatedEventTest {
    UserCourseModuleSystemCreatedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModuleSystemCreatedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModuleSystemCreatedEvent event = UserCourseModuleSystemCreatedEvent.fromDescription("The user with id '2' created the 'resource' activity with course module id '4369'.");
