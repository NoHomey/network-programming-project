...
public class UserCourseModuleSystemDeletedEventTest {
    UserCourseModuleSystemDeletedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModuleSystemDeletedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModuleSystemDeletedEvent event = UserCourseModuleSystemDeletedEvent.fromDescription("The user with id '2' deleted the 'resource' activity with course module id '4369'.");
