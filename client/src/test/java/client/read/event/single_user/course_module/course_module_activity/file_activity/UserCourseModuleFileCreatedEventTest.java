...
public class UserCourseModuleFileCreatedEventTest {
    UserCourseModuleFileCreatedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModuleFileCreatedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModuleFileCreatedEvent event = UserCourseModuleFileCreatedEvent.fromDescription("The user with id '2' created the 'resource' activity with course module id '4369'.");
            assertEquals("The user with id '2' created the 'resource' activity with course module id '4369'.", event.valueForDescription());
    ...
    public void testValueForEventName() {
        assertEquals("Course module created", event.valueForEventName());
    }
