...
public class UserCourseModuleSystemViewedEventTest {
    UserCourseModuleSystemViewedEvent event;

    @Before
    public void initialize() {
        event = new UserCourseModuleSystemViewedEvent(2, 4369);
    }

    @Test
    public void testFromDescription() {
        try {
            UserCourseModuleSystemViewedEvent event = UserCourseModuleSystemViewedEvent.fromDescription("The user with id '2' viewed the 'resource' activity with course module id '4369'.");
