...
public class DiscussionDeletedEventTest {
    DiscussionDeletedEvent event;

    @Before
    public void initialize() {
        event = new DiscussionDeletedEvent(2436, 209, 81);
    }

    @Test
    public void testFromDescription() {
        try {
            DiscussionDeletedEvent event = DiscussionDeletedEvent.fromDescription("The user with id '2436' has deleted the discussion with id '209' in the forum with course module id '81'.");
            assertEquals("The user with id '2436' has deleted the discussion with id '209' in the forum with course module id '81'.", event.valueForDescription());
    ...
    public void testValueForEventName() {
        assertEquals("Discussion deleted", event.valueForEventName());
    }
