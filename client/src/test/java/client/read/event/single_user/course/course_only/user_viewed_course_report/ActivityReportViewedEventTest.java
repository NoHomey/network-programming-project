...
public class ActivityReportViewedEventTest {
    ActivityReportViewedEvent event;

    @Before
    public void initialize() {
        event = new ActivityReportViewedEvent(2, 49);
    }

    @Test
    public void testFromDescription() {
        try {
            ActivityReportViewedEvent event = ActivityReportViewedEvent.fromDescription("The user with id '2' viewed the outline activity report for the course with id '49'.");
            assertEquals("The user with id '2' viewed the outline activity report for the course with id '49'.", event.valueForDescription());
    ...
    public void testValueForComponent() {
        assertEquals("Activity report", event.valueForComponent());
    }

    @Test
    public void testValueForEventName() {
        assertEquals("Activity report viewed", event.valueForEventName());
    }
