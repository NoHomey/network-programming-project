...
public final class CalendarEventUpdatedEvent extends CalendarEventActionEvent {
    ...
    public static CalendarEventUpdatedEvent fromDescription(String description) throws DescriptionMatchFailException {
        final CalendarEventActionEvent.DescriptionData data = CalendarEventActionEvent.fromDescription(pattern, description);
        return new CalendarEventUpdatedEvent(data.userID, data.event, data.eventID);
    }

    public CalendarEventUpdatedEvent(int userID, String event, int eventID) {
