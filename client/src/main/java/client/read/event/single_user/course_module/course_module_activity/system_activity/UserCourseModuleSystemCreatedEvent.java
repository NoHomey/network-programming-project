...
public final class UserCourseModuleSystemCreatedEvent extends UserCourseModuleSystemActivityEvent {
    ...
    public static UserCourseModuleSystemCreatedEvent fromDescription(String description) throws DescriptionMatchFailException {
        ...
        return new UserCourseModuleSystemCreatedEvent(data.userID, data.courseModuleID); 
    }

    public UserCourseModuleSystemCreatedEvent(int userID, int courseModuleID) {
